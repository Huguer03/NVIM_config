...
function _G.set_terminal_keymaps()
  local opts = {buffer = 0}
  vim.keymap.set('t', '<esc>', [[<C-\><C-n>]], opts) -- Salir de modo terminal con Esc
  vim.keymap.set('t', '<C-h>', [[<Cmd>wincmd h<CR>]], opts) -- Moverse a la izquierda
  vim.keymap.set('t', '<C-j>', [[<Cmd>wincmd j<CR>]], opts) -- Moverse abajo
  vim.keymap.set('t', '<C-k>', [[<Cmd>wincmd k<CR>]], opts) -- Moverse arriba
  vim.keymap.set('t', '<C-l>', [[<Cmd>wincmd l<CR>]], opts) -- Moverse a la derecha
end

-- Solo aplica estos mapeos cuando se abre la terminal
